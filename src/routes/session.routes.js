...
import { startSession, sendSessionMessage, getSession, getSessionMessages, getUserSessions } from "../controllers/session.controller.js";
import { generateReport , getReport} from "../controllers/generateReport.controller.js";

const router = Router();

router.post("/", verifyJWT, startSession);
router.get("/", verifyJWT, getUserSessions);
